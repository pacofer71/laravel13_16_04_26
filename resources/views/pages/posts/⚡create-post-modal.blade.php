...
new class extends Component {
    ...
    public function store()
    {
        ...
        $this->dispatch('evtPostCreado');
        $this->dispatch('mensaje', 'Post Guardado');
        //session()->flash('mensaje', 'Post Guardado');
        $this->cancelar();
    }
...
<div>
    <button
        class="font-semibold inline-flex items-center gap-1 p-2 bg-gray-600 hover:bg-gray-800 text-white rounded-lg whitespace-nowrap"
        wire:click="$set('openModal', true)">
        <x-heroicon-o-plus class="w-4 h-4" />
        NUEVO
    </button>
    <flux:modal name="create-post" wire:model="openModal" class="w-full md:max-w-2xl lg:max-w-4xl xl:max-w-6xl">
        <div class="space-y-2">
            <div>
            ...
            <div wire:ignore x-data x-on:trix-change="$wire.set('cform.contenido', $refs.trix.value, false)"
                class="mb-4">
            ...
            <div class="mt-4 w-full flex flex-row-reverse gap-2">
                <flux:button icon="paper-airplane" variant="primary" wire:click="store" wire:loading.attr="disabled">ENVIAR</flux:button>
